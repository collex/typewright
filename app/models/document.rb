...
class Document < ActiveRecord::Base
   ...
   def get_page_info(page, include_word_stats, include_image_info = true )
      ...
      if include_image_info
         result = { :doc_id => self.id, 'ocr_source'=> src.to_s, :page => page, :num_pages => num_pages, :img_full => img_full,
         ...
         result = { :doc_id => self.id, 'ocr_source'=> src.to_s, :page => page, :num_pages => num_pages, :lines => lines, :title => title,
